...
function App() {
        ...
        const newMat = [
            ...data
                ...
                .map((m, i) => {
                    let unit = 1;
                    let mat = m.trim();
                    if (mat[0] && parseInt(mat[0]) && mat[1] && mat[1].toLowerCase() === "x") {
                        unit = parseInt(mat[0]);
                    }
    ...
    useEffect(() => {
        const newTotal = allMaterials.reduce((acc, val) => acc + val.price * val.units, 0);
            ...
            {loading ? (
                ...
                /> */}
                            ...
                            {allMaterials.length ? (
                                ...
                                >
                                    <h5>{address}</h5>
                                    {allMaterials.map(({ id, material, price, units }: MaterialsType, i: number) => {
                                        return (
                                            <div
                                                key={i}
                                                style={{
                                            ...
                                            >
                                                ...
                                                <input
                                                    ...
                                                    onBlur={() => {
                                                        ...
                                                        setPrice(arrSplit.at(-1) as string, price.toString());
                                                    }}
